...
@Service
public class UnvaultedPrimePostGenerator extends PrimePostGenerator {

    public UnvaultedPrimePostGenerator(MustacheEngine mustacheEngine) {
    ...
    protected Matter generateFrontMatter(GeneratedPrimeItem primeItem) {
        ...
        matter.setSeoTitle(String.format("How To Get %1$s. %1$s Relics Farm. %1$s Unvaulted!", primeItem.getName()));
        return matter;
    }
